...
export class InvoiceEditComponent {
  ...
  ngOnInit(){
    ...
    // console.log("dkfjajf")
    // console.log(this.invoiceFrom.value.doctorOption)


    this.invoiceFrom.value.doctorOption.valueChanges.pipe(debounceTime(200)).subscribe((docId: number)=>{
    ...
    this.employeeService.getEmployeeById(3).subscribe(emp=>{
      ...
      this.clinicService.getById(this.targetemployee.clinicId).subscribe(clinic=>{
        ...
        this.clinic_id = this.targetService._id;
  ...
  onSubmit(){
    ...
    // this.invoiceFrom.value.appointment_id = this.targetAppointment._id;
    ...
    this.invoiceFrom.value.data = this.todayDate;
